        ...
        <ScrollView
          ...
          {leagueName && (
            <View
              ...
              <Text variant="h4" color={theme.text} style={styles.infoLabel}>
                {t("league")}
              </Text>
                ...
                <View key={member.id} style={styles.selectedPlayerItem}>
                  ...
                  {member.role === "admin" && (
                    <View style={styles.adminBadge}>
                      <Ionicons name="crown" size={12} color={colors.warning} />
                    </View>
                  )}
                </View>
              ))}
          ...
          <View
            ...
            <Text variant="h4" color={theme.text} style={styles.summaryTitle}>
              {t("gameSummary")}
            </Text>
